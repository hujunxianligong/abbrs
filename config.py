...
# 分类训练集路径
CLASSSIFY_TRAIN_CORPUS_FILE = CORPUS_PROCRSS_RESULT_PATH+'1526504346_set_crf++_model'
# 名称分类 特征模板
CLASSSIFY_TEMPLATE_FILE = CLASSIFY_DIR+'/template/template0'
# 简称缩略训练结果模型存放地址
CLASSSIFY_MODEL_PATH = CLASSIFY_DIR+'/model/'
# CRF模型路径
CLASSSIFY_MODEL_FILE = CLASSSIFY_MODEL_PATH + '1526505098_crf_abbr_classify_model'
...
# 简称缩略模型加载路径
ABBR_MODEL_FILE = ABBR_TRAIN_MODEL_PATH+'1525987387_crf_abbr_keep_model'
